...
// Ej 22: Explique la diferencia entre find y findIndex: FIND retorna el primer elemeno que cumpla con la condicion que damos, y FINDINDEX retorna el INDICE del elemento
// que cumpla la condicion que damos.

// // Ej 23: Utilice find para encontrar el primer país que contenga sólo seis letras en el array de países.

// const sixLetterCountry = countries.find((country) => {
//     return country.length === 6
// })
// console.log(sixLetterCountry);

// Ej 24: Utilice findIndex para encontrar la posición del primer país que contenga sólo seis letras en el array de países.

// const positionSixLetterCountry = countries.findIndex((country) => {
//     return country.length === 6
// })
// console.log(positionSixLetterCountry);

// // Ej 25: Utilice findIndex para encontrar la posición de Norway si no existe en el array obtendrá -1.

// const positionNorway = countries.findIndex((country) => {
//     return country.toLowerCase() === "norway"
// })
// console.log(positionNorway);

// // Ej 26: Utilice findIndex para encontrar la posición de Russia si no existe en el array obtendrá -1.

// const positionRussia = countries.findIndex((country) => {
//         return country.toLowerCase() === "russia"
//     })
